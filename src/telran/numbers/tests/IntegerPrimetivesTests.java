...
class IntegerPrimetivesTests {
	...
	@Test
	void getLengthByte() {
		assertEquals(1, IntegerPrimitives.getLenghthByte());
	}
	...
	@Test
	void getLengthChar() {
		assertEquals(2, IntegerPrimitives.getLenghthChar());
	}
	...
	@Test
	void getLengthShort() {
		assertEquals(2, IntegerPrimitives.getLenghthShort());
	}
	...
	@Test
	void getLengthInt() {
		assertEquals(4, IntegerPrimitives.getLenghthInt());
	}
	...
	@Test
	void getLengthLong() {
		assertEquals(8, IntegerPrimitives.getLenghthLong());
	}
